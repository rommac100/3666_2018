...
public class Internal_Gyroscope implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        if (timestamp != 0) {
            ...
            deltaRotationVector[0] = (float)Math.toDegrees(axisX/dT);
            deltaRotationVector[1] = (float)Math.toDegrees(axisY/dT);
            deltaRotationVector[2] = (float)Math.toDegrees(axisZ/dT);
        }
