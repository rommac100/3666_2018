...
public class BallColour_Process_Alternate extends OpenCVPipeline {
    private Colour_Ball selected_Ball_Colour = Colour_Ball.Null;

    public SideColor sideColor = SideColor.BLUE;

    private static final String TAG = "RelicRecoveryProcessor";
    ...
    public void SetSideColor(SideColor color){
        sideColor = color;
    }
